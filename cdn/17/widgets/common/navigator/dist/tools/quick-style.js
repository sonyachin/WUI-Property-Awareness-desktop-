...
`,P=e=>{const{className:o,data:l,progress:s=0,type:d,navStyle:u,vertical:c,advanced:p,variant:g,onChange:m,activeView:b,standard:h,paginationFontColor:y,navArrowColor:x,theme:f,a11yLandmark:$,addToA11ySkip:k,ariaLabel:P,widgetId:C}=e,M=j(e,["className","data","progress","type","navStyle","vertical","advanced","variant","onChange","activeView","standard","paginationFontColor","navArrowColor","theme","a11yLandmark","addToA11ySkip","ariaLabel","widgetId"]),{current:B,totalPage:z,showPageNumber:R,scrollable:N,disablePrevious:O,disableNext:L,previousText:E,previousIcon:_,nextText:G,nextIcon:V,showIcon:F,gap:q,alternateIcon:U,activedIcon:W,showText:D,showTitle:K,iconPosition:X,textAlign:Y,hideThumb:H}=h||{},Q=t.React.useMemo(()=>{const e={role:$||("nav"===d?"tablist":void 0),"aria-label":P};if(k){const o=`${t.WIDGET_PREFIX_FOR_A11Y_SKIP}${C}`;return"slider"===d?Object.assign(Object.assign({},e),{id:o}):Object.assign(Object.assign({},e),{id:o,tabIndex:-1})}return e},[k,$,d,P,C]),J=t.React.useRef(()=>0);t.React.useEffect(()=>(J.current=t.lodash.throttle(e=>{let t=+e.target.value;t=Number((t/100).toFixed(2)),null==m||m("slider",t)},100),()=>{J.current.cancel()}),[m]);const Z=t.React.useCallback(e=>b===w(e),[b]),ee=((e,o,n,i,l,r,a)=>v(()=>{var s,d,u;const c=null===(u=null===(d=null===(s=(0,t.getAppStore)())||void 0===s?void 0:s.getState())||void 0===d?void 0:d.appContext)||void 0===u?void 0:u.isRTL;return"slider"===e?T(i,r,c):n?"nav"===e?S(o,i,l,a):"navButtonGroup"===e?I(i):null:null},[n,i,e,o,l,a,r]))(d,u,p,g,c,H,x),te=t.React.useMemo(()=>{var e,o,n,i,l,r,s;const d=(0,a.getThemeModule)(null==f?void 0:f.uri);if(a.mapping.whetherIsNewTheme(d))return null;const c=(null===(s=null===(r=null===(l=null===(i=null===(n=null===(o=null===(e=null==d?void 0:d.variables)||void 0===e?void 0:e.components)||void 0===o?void 0:o.nav)||void 0===n?void 0:n.variants)||void 0===i?void 0:i[u])||void 0===l?void 0:l.item)||void 0===r?void 0:r.default)||void 0===s?void 0:s.color)||"";return t.css`
      ${c?"":".nav-link:not(:hover):not(.active) {\n        color: var(--sys-color-action-text);\n      }"}
      .direction-button:not(:hover):not(.active):not(:disabled) {
        color: var(--sys-color-action-text);
      }
      ${y?"":".jimu-page-number {\n        color: var(--sys-color-action-text);\n      }"}
    `},[u,y,null==f?void 0:f.uri]),oe=(e=>v(()=>t.css`
    ...
    `,[e]))(d),ne=t.hooks.useTranslation(n.defaultMessages);return(0,i.jsxs)("div",Object.assign({className:(0,t.classNames)("navigation",o),css:[A,ee,oe,te]},M,{children:["nav"===d&&(0,i.jsx)(n.Navigation,Object.assign({keepPaddingWhenOnlyIcon:r(e),onLinkClick:e=>{const t=w(e);null==m||m("nav",t)},vertical:c,isActive:Z,scrollable:N,data:l,gap:q,type:u,showIcon:F,alternateIcon:U,activedIcon:W,showText:D,showTitle:K||D||r(e)&&!D&&F,isUseNativeTitle:!0,iconPosition:X},Q,{textAlign:Y})),"slider"===d&&(0,i.jsx)(n.Slider,Object.assign({className:"h-100",value:100*s,hideThumb:H,onChange:e=>{var t;null===(t=e.persist)||void 0===t||t.call(e),J.current(e)},formatter:e=>{var t;const o=(null===(t=null==l?void 0:l.find(e=>w(e)===b))||void 0===t?void 0:t.name)||"";return`${ne("percentage")} ${Math.round(+e)}. ${o}`}},Q)),"navButtonGroup"===d&&(0,i.jsx)(n.NavButtonGroup,Object.assign({variant:"tertiary"===u?"text":"outlined",previousText:E,previousIcon:_,nextText:G,nextIcon:V,vertical:c,disablePrevious:O,disableNext:L},Q,{onChange:e=>{null==m||m("navButtonGroup",e)},children:R&&(0,i.jsx)(n.PageNumber,{current:B,totalPage:z,css:t.css`color: ${y}`})}))]}))},C=e=>{const{title:o,children:n,selected:l,onClick:r}=e,s=(()=>{const e=(0,a.useTheme)(),o=(0,a.useTheme2)(),n=(0,a.useUseTheme2)(),i=window.jimuConfig.isBuilder!==n?o:e,l=(window.jimuConfig.isBuilder!==n?e:o).sys.color.primary.light,r=i?i.sys.color.surface.background:"transparent",s=i?i.sys.color.surface.backgroundText:"inherit";return t.React.useMemo(()=>t.css`
      width: 100%;
  ...
  `,[l,r,s])})();return(0,i.jsxs)("div",{css:s,title:o,className:(0,t.classNames)("quick-style-item",{selected:l}),onClick:r,children:[(0,i.jsx)("div",{className:"overlay"}),n]})},M=(0,t.Immutable)([{name:"v1",value:"p1,v1"},{name:"v2"},{name:"v3"},{name:"v4"}]),B=t.css`
  &.body {
    display: flex;
